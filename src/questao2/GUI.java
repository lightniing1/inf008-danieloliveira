...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jComboBox9, 0, 258, Short.MAX_VALUE)
        ...
        jComboBox13.setModel(jComboBox4.getModel());
            ...
            .addGroup(jPanel21Layout.createSequentialGroup()
                ...
                .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel21Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jComboBox24, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel21Layout.createSequentialGroup()
                        .addComponent(jLabel40)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jComboBox25, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jComboBox16, javax.swing.GroupLayout.PREFERRED_SIZE, 353, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        escola.AdicionaHorarioCurso(jComboBox4.getSelectedItem().toString(), jComboBox9.getSelectedItem().toString());
        jComboBox21.addItem(jComboBox9.getSelectedItem().toString());
        jComboBox9.removeItemAt(jComboBox9.getSelectedIndex());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        escola.RemoveCurso(jComboBox1.getSelectedItem().toString());
        jComboBox4.removeAllItems();
        for (int i = 0; i < escola.QtdCursos(); i++){
            String curso = escola.NomeCurso(i);
            jComboBox4.addItem(curso);
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        escola.AdicionaHorarioCurso(jComboBox4.getSelectedItem().toString(), jComboBox9.getSelectedItem().toString());
        jComboBox9.addItem(jComboBox21.getSelectedItem().toString());
        jComboBox21.removeItemAt(jComboBox9.getSelectedIndex());
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        escola.RemoveDisciplina(idd_disciplina);
        ...
        for (int i = 0; i < escola.QtdDisciplinas(); i++){
            ...
            jComboBox6.addItem(id_disciplina + " " + nome_disciplina);
        }
    ...
    private void jComboBox20FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jComboBox20FocusGained
        // TODO add your handling code here:
        String[] disciplina = jComboBox19.getSelectedItem().toString().split(" ", 2);
        Integer idd_disciplina = Integer.parseInt(disciplina[0]);
        
        for (int i = 0; i < escola.QtdAlunos(); i++){
            if (escola.VerificaAlunoNaDisciplina(i, idd_disciplina)){
                String nome_aluno = escola.NomeAluno(i);
                Integer id_aluno = escola.MatriculaAluno(i);
                jComboBox20.addItem(id_aluno + " " + nome_aluno);
            }
        }
    ...
    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        ...
        String[] aluno = jComboBox20.getSelectedItem().toString().split(" ", 2);
        Integer idd_aluno = Integer.parseInt(aluno[0]);
        
        Float nota = Float.parseFloat(jTextField5.getText());
        
        escola.AdicionaNotaAoAlunoNaDisciplina(idd_aluno, idd_disciplina, nota);
